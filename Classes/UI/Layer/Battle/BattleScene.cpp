...
void BattleScene::start(int mapId)
{
    ...
    UnderWorld::Core::UnitSetting us04;
    us04.setUnitTypeName("狼人独角兽");
    cs0[4].setUnitSetting(us04);
    cs0[4].setMaxProduction(5);
    UnderWorld::Core::UnitSetting us05;
    us05.setUnitTypeName("狼人森林之魂");
    cs0[5].setUnitSetting(us05);
    cs0[5].setMaxProduction(5);
    UnderWorld::Core::UnitSetting us06;
    us06.setUnitTypeName("七恶魔拉玛什图");
    cs0[6].setUnitSetting(us06);
    cs0[6].setMaxProduction(5);
    UnderWorld::Core::UnitSetting us07;
    us07.setUnitTypeName("莉莉丝");
    cs0[7].setUnitSetting(us07);
    cs0[7].setMaxProduction(5);
